...
<style>
    ...
    /* Data tables */
    .data-table { width: 100%; border-collapse: collapse; font-size: 6pt; margin-bottom: 10pt; table-layout: auto; }
    .data-table th { background: #f9fafb; padding: 3pt 4pt; text-align: left; font-weight: 600; border-bottom: 1.5px solid #e5e7eb; font-size: 6pt; word-wrap: break-word; }
    .data-table td { padding: 2pt 4pt; border-bottom: 1px solid #f3f4f6; word-wrap: break-word; font-size: 6pt; max-width: 80pt; }
